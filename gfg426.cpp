...
Constraints:
1 ≤ s.size() ≤ 105
Approach 1 -Brute force try all the possible method to solve it using nested loop TC:O(n^2) SC:O(1)
Approach 2 - using the counting total brackets TC:O(n) SC: O(1) 
*/
#include<iostream>
#include<vector>
#include<string>
